 ...
 */
class DeseaseRepository extends \Doctrine\ORM\EntityRepository
{
    public function validate($form) {
        ...
        if($action !== 'd') {
            ...
            $deseaseExist = $this->getEntityManager()->getRepository(DeseaseEntity::class)
            ...
            if($action != 'u' && $deseaseExist){
                $errors[] = 'Desease already exist.';
            }
    ...
    public function ajax_list(array $get, array $userData){
        ...
        if($userData['type'] == 'Super Admin'|| in_array('CMS Desease Update', $userData['accesses'])){

            $formUrl = $url . '/desease/ajax_form';  
            $hasUpdate = true;
        }
