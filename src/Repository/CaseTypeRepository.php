 ...
 */
class CaseTypeRepository extends \Doctrine\ORM\EntityRepository
{
    public function validate($form) {
        ...
        if($action !== 'd') {
            ...
            $case_typeExist = $this->getEntityManager()->getRepository(CaseTypeEntity::class)
            ...
            if($action != 'u' && $case_typeExist){
                $errors[] = 'Case Type already exist.';
            }
    ...
    public function ajax_list(array $get, array $userData){
        ...
        if($userData['type'] == 'Super Admin'|| in_array('CMS Case Type Update', $userData['accesses'])){

            $formUrl = $url . '/case_type/ajax_form';  
            $hasUpdate = true;
        }
