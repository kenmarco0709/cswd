...
class UserController extends AbstractController
{
    ...
    /**
     * @Route("/encoder_autocomplete", name="user_encoder_autocomplete")
     */
    public function encoderAutocompleteAction(Request $request) {

        return new JsonResponse(array(
            'query' => 'encoder_users',
            'suggestions' => $this->getDoctrine()->getManager()->getRepository(UserEntity::class)->encoder_autocomplete_suggestions($request->query->all(), $this->get('session')->get('userData'))
        ));
    }
